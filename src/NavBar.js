...
const NavBar = (props) =>{
    ...
    return(
        <ul className=" nav nav-pills mb-3" id="pills-tab" role="tablist">
            <li className="nav-item">
              <a className={props.navStatus == 1 ? "nav-link active":"nav-link"} id="pills-home-tab" data-toggle="pill" href="#pills-home" role="tab"
                aria-controls="pills-home" aria-selected="true" onClick = {props.expandPostCard}>Job Postings</a>
            </li>
            <li className="nav-item">
              <a className={props.navStatus == 2 ? "nav-link active":"nav-link"} id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
